...
<head>
    ...
    <style>
        .login-page {
            background-image: linear-gradient(to bottom, rgb(0 0 0 / 90%), hsl(0deg 0% 0% / 82%)), url(assets/dist/img/bg1.jpeg);
...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo text-center">
            <img src="{{ asset('assets/dist/img/logo.png') }}" class="img-fluid img-circle p-3" width="150"
                alt="">
        </div>
        <!-- /.login-logo -->
        @if (session('info'))
