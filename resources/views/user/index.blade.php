...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">{{ ucwords($type) }}</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
            ...
            var table = $('table').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        data: 'jenis_kelamin',
                        render: function(data, type, row, meta) {
                            return row.jenis_kelamin == 'L' ? 'Pria' : 'Perempuan';
                        },
                    },
                    {
                        data: 'telepon',
            ...
            table.on("click", "#edit", function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#modal form').find('#jenis_kelamin').val(data.jenis_kelamin)
                            .change();
                        $('#modal form').find('#telepon').val(data.telepon);
