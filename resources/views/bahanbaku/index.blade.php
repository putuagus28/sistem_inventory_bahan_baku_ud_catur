                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex flex-row align-items-center">
                            <h3 class="card-title"><i class="fa fa-box-open" aria-hidden="true"></i></h3>
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kode_bahanbaku" id="kode_bahanbaku" class="form-control"
                                        readonly>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_bahanbaku" id="nama_bahanbaku" class="form-control">
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
...
@section('script')
    ...
    <script>
        function getkode() {
            $.get("{{ url('kode/bahanbaku') }}",
                function(data, textStatus, jqXHR) {
                    $('#kode_bahanbaku').val(data);
                },
            );
        }
            ...
            table.on("click", "#edit", function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $('#modal form').find('#kode_bahanbaku').val(data.kode_bahanbaku);
                        $('#modal form').find('#nama_bahanbaku').val(data.nama_bahanbaku);
