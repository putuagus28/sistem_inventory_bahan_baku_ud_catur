                        ...
                        <form method="POST">
                            ...
                            <div class="card-body row">
                                ...
                                <div class="col-12 col-md-3">
                                    <select class="form-control" name="bahanbaku" id="bahanbaku">
                                        <option value="" disabled selected>Pilih</option>
                                        @foreach ($bahanbaku as $no => $item)
                                            <option value="{{ $item->id }}">{{ ucwords($item->nama_bahanbaku) }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-6 my-auto">
                                    ...
                                    <p class="text-center mt-4" id="text_caption">Berdasarkan Bahan Baku : <span
                                            id="d1" class="mr-2"></span>
                                    </p>
                                </div>
                            </div>
                            <br>
                            <table class="table table-bordered table-striped" id="table1">
                                <thead>
                                    <tr>
                                        <th>Nama Bahan Baku Sisa</th>
                                        <th>Produksi</th>
                                        <th>Ukuran</th>
                                        <th>Satuan</th>
                                        <th>Jumlah Bahan Baku Sisa</th>
                                        <th>Keterangan</th>
                                    </tr>
                                </thead>
                                <tbody>
        ...
        $(document).ready(function() {
            ...
            var validator = $("form").validate({
                ...
                submitHandler: function(form) {
                    ...
                    var bahanbaku = $('#bahanbaku option:selected').text();
                    $('#text_caption #d1').text(bahanbaku);
                                ...
                                if (res.query.length >= 1) {
                                    $.each(res.query, function(i, val) {
                                        ...
                                        html += '<td>' + val.bahanbaku
                                            .nama_bahanbaku +
                                            '</td>';
                                        html += '<td>' + val.produksi.keterangan +
                                            '</td>';
                                        html += '<td>' + val.ukuran +
                                            '</td>';
                                        html += '<td>' + val.satuan +
