        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    <h4 class="modal-title"><span class="event-icon mr-3"></span><span class="event-title"></span></h4>
                    ...
                    <div class="card card-purple">
                        ...
                        <div class="card-header">
                            <h3 class="card-title font-weight-bold"><i class="fas fa-chart-bar"></i> <span
                                    id="chart_title"></span> Grafik Penjualan Tahun
                                {{ date('Y') }}</h3>
                        </div>
                        <div class="card-body">
                            <div class="chart">
        ...
        (function() {
            ...
            jQuery(function() {
                ...
                jQuery('#calendar').fullCalendar({
                    ...
                    events: [{
                        title: 'laporan bahan baku masuk dan bahan baku keluar',
                        description: 'laporan bahan baku masuk dan bahan baku keluar',
                        start: '2022-10-31',
                        end: '2022-10-31',
